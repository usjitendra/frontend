...
//       title: "Send Reminder",
//       description:
//         "Automated reminder system supporting SMS, email, and push notifications. Customizable timing and messaging.",
//       icon: Bell,
...
//       description:
//         "Notify team members about new appointments, cancellations, and schedule changes.",
//       icon: Users,
...
//       description:
//         "Send bulk email notifications and marketing campaigns to patient lists.",
//       icon: Mail,
...
//       title: "SMS Alerts",
//       description:
//         "Send urgent SMS notifications for critical updates and emergency communications.",
//       icon: MessageSquare,
